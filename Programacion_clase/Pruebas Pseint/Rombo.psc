	Algoritmo sin_titulo
		...
		Repetir
			Escribir "¿Filas del primer triangulo?"
			Leer nfilas
		...
		Para fila<-1 Hasta nfilas-1 Con Paso 1 Hacer //Este "para" establece el numero de filas que especificó el usuario
			Para cnt1<-1 Hasta nfilas-fila Con Paso 1 Hacer
				Escribir Sin Saltar " "
			Fin Para
			Para aster<-1 Hasta fila+fila-1 Con Paso 1 Hacer
				Si respuesta=="SI" || aster==1 || aster==fila+fila-1   Entonces
					Escribir sin saltar "*"
				SiNo
					Escribir Sin Saltar " "
				Fin Si
			...
			Escribir " "
		Fin Para
		Para fila<-nfilas Hasta 1 Con Paso -1 Hacer //Este "para" establece el numero de filas que especificó el usuario
			Para cnt1<-1 Hasta nfilas-fila Con Paso 1 Hacer
				Escribir Sin Saltar " "
			Fin Para
			Para aster<-fila+fila-1 Hasta 1 Con Paso -1 Hacer
				Si respuesta=="SI" || aster==1 || aster==fila+fila-1   Entonces
					Escribir sin saltar "*"
				SiNo
					Escribir Sin Saltar " "
